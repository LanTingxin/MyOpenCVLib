...
using std::endl;
using std::vector;
#define img1_path "F://Learning-OpenCV-3_examples-master/example_16-01-imgA.png"
#define img2_path "F://Learning-OpenCV-3_examples-master/example_16-01-imgB.png"
...
int main(int argc, char** argv) {
    ...
    // results.
    //
    cv::Mat imgA = cv::imread(img1_path, CV_LOAD_IMAGE_GRAYSCALE);
    cv::Mat imgB = cv::imread(img2_path, CV_LOAD_IMAGE_GRAYSCALE);
